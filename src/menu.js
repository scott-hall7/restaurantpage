...
function egg() {
    ...
    eggDescription.textContent = "Just a plain-old hardboiled egg. Emphasis on hard. Very real!";
...
function bacon() {
    ...
    baconDescription.textContent = "We only cook our bacon extra crispy, so expect a crunch.";
